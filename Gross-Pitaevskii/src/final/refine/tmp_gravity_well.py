...
class GrossPitaevskiiPINN(nn.Module):
    ...
    def airy_solution(self, x, n):
        """
        Linear eigenfunction: Ψ_n(x) = Ai(x + x_n)
        """
...
if __name__ == "__main__":
    ...
    for p in nonlinearity_powers:
        ...
        filename = f"gravity_well_tmp_3.pkl"

        # Create plotting and model saving directory
        p_save_dir = f"gravity_well_tmp_3"
        ...
        if run_comparison:
            ...
            comparison_save_dir = f"comparison_results_p{p}_{potential_type}_with_pretraining_3"
