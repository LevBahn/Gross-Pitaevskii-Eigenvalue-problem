...
class GrossPitaevskiiPINN(nn.Module):
    ...
    def __init__(self, layers, hbar=1.0, m=1.0, mode=0, gamma=1.0, beta=1.0, L=1.0, use_residual=True, use_perturbation=True):
        """
        Parameters
        ----------
        layers : list of int
    ...
    def pde_loss(self, inputs, predictions, gamma, beta, p, potential_type="box", precomputed_potential=None):
        """
...
def train_gpe_model(gamma, beta_values, modes, p, X_train, lb, ub, layers,
    ...
    for mode in modes:
        ...
        for beta in beta_values:
            ...
            model = GrossPitaevskiiPINN(layers, mode=mode, gamma=gamma, beta=beta, L=L).to(device)
...
if __name__ == "__main__":
    ...
    for p in nonlinearity_powers:
        ...
        filename = f"vary_potential_parameter.pkl"

        # Create plotting and model saving directory
        p_save_dir = f"vary_potential_parameter"
