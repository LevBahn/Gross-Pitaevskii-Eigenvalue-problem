...
class GrossPitaevskiiPINN(nn.Module):
    ...
    def riesz_loss(self, inputs, predictions, gamma, p, potential_type="box", precomputed_potential=None):
        ...
        interaction_term = 0.5 * (2.0 * gamma / (p + 1)) * torch.sum(torch.abs(u) ** (p + 1)) * dx / norm_factor
...
def train_gpe_model(gamma_values, modes, p, X_train, lb, ub, layers, epochs,
                    ...
                    early_stopping_patience=500, min_epochs=5000):
    """
...
if __name__ == "__main__":
    ...
    # Setup parameters
    N_f = 4000  # Number of collocation points
    epochs = 501  # Increased epochs for better convergence
    ...
    for p in nonlinearity_powers:
        ...
        for potential_type in all_potentials:
            ...
            # Plot loss visualizations
            print("Generating loss visualization...")
            plot_improved_loss_visualization(training_history, modes, gamma_values, epochs, p_save_dir)
