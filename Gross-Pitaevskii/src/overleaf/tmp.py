...
class GrossPitaevskiiPINN(nn.Module):
    ...
    def riesz_loss(self, inputs, predictions, gamma, p, potential_type="harmonic", precomputed_potential=None):
        ...
        kinetic_term = torch.sum(u_x ** 2) * dx / norm_factor
        ...
        for gamma in gamma_values:
            ...
            for epoch in range(epochs):
                ...
                if mode == 0:
                    ...
                    physics_loss = riesz_energy / interval_length + pde_loss / interval_length
                    ...
                    physics_loss = pde_loss / interval_length
...
def plot_combined_grid(models_by_mode, X_test, gamma_values, modes, p, save_dir="plots_tmp"):
    """
...
def plot_mu_vs_gamma(mu_table, modes, p, save_dir="plots_tmp"):
    """
...
if __name__ == "__main__":
    ...
    for p in nonlinearity_powers:
        ...
        p_save_dir = f"plots_test_nonlinearity"
