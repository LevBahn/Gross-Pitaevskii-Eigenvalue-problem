...
def train_gpe_model(gamma_values, modes, p, X_train, lb, ub, layers, epochs,
                    ...
                    early_stopping_patience=1000, min_epochs=3000):
    """
        ...
        for gamma in gamma_values:
            ...
            for epoch in range(epochs):
                ...
                if mode >= 2 and gamma > 0:
                    ...
                    total_loss = 3.0 * pde_loss + 10.0 * boundary_loss + 20.0 * norm_loss + 5.0 * sym_loss
                else:
...
if __name__ == "__main__":
    ...
    for p in nonlinearity_powers:
        ...
        for potential_type in all_potentials:
            ...
            p_save_dir = f"shampoo_p{p}_{potential_type}"
            ...
            if potential_type == 'box':
                ...
                for mode in modes:
                    ...
                    energy = ((mode + 1) ** 2 * np.pi ** 2) / (
                                2 * L ** 2)  # Box is assumed to be from lower bound to upper bound 1
