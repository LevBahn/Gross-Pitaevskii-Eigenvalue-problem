...
def train_and_save_pinn(X, N_u, N_f, layers, eta, epochs, model_save_path):
    """
...
if __name__ == "__main__":
    ...
    for eta in etas:
        ...
        model, loss_history = train_and_save_pinn(X, N_u=N_u, N_f=N_f, layers=layers, eta=eta, epochs=epochs, model_save_path=model_save_path)
        models.append(model)
